...
<head>
    ...
    <title>Welcome | Secret Notes</title>
...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="absolute top-4 right-4 space-x-3 z-50">
        <a href="{{ route('login') }}"
            class="inline-block px-4 py-2 text-sm font-semibold text-indigo-600 border border-indigo-600 rounded-full hover:bg-indigo-50 transition">
            Login
        </a>
        <a href="{{ route('register') }}"
            class="inline-block px-4 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-full hover:bg-indigo-700 transition">
            Register
        </a>
    </div>
                ...
                <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-8">
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <p class="text-gray-600 leading-relaxed">
                            <strong>Secret Notes</strong> adalah aplikasi web untuk mengirimkan catatan rahasia secara
                            aman dan
                            <strong>sekali baca</strong>. Setelah dibuka satu kali, catatan akan langsung terhapus dan
                            tidak
                            bisa diakses kembali.
                            Cocok untuk mengirimkan informasi sensitif seperti password sementara, pesan privat, token
                            rahasia,
                            atau link OTP.
                        </p>
                    </div>
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <p class="text-gray-600 mb-3">
                            Di luar pengembangan Secret Notes, ke depan akan hadir berbagai tools sederhana namun
                            bermanfaat
                        ...
                        <ul class="list-disc list-inside text-gray-600 space-y-1">
                            ...
                            <li>🗓️ <strong>AgendaLink</strong>: buat link janji ketemuan dengan sinkronisasi kalender
                            </li>
                            ...
                            <li>🧠 <strong>MindVault</strong>: arsip pribadi untuk ide, artikel, dan referensi penting
                            </li>
                        ...
                        <p class="text-gray-600 mt-3">
                            Semua proyek ini akan dibuat dengan semangat (lek gak mager wkwk): <em>open source, ringan,
                                privat, dan tanpa iklan</em>.
                        </p>
                    </div>
                    ...
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <p class="text-gray-600">
                            Created by <strong class="text-indigo-700">Stevent</strong>, pengembang web yang tertarik
                            pada
                            privasi, keamanan informasi, dan produktivitas digital. Proyek ini dibangun sebagai
                            pembelajaran dan
                        ...
                        <div class="mt-3 flex items-center space-x-4 text-sm text-gray-500">
                            ...
                            <a href="https://instagram.com/a.stevents" target="_blank"
                                class="hover:text-pink-500 underline">📷
                                Instagram</a>
                        </div>
                    </div>
